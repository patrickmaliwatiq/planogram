...
f.isFunction(c.validate)){var e=c.validate(d);if(e)return a.error?a.error(this,e,a):this.trigger("error",this,e,a),!1}(c=c.write?f.isFunction(c.write)?c.write.call(this,d,a):this.model.set(c.write,d,a):!0)&&this._setAttribute(b,d,a);return c},constructor:function(b){var d={},a=this;this.model=b;this._escapedAttributes={};this.cid=f.uniqueId("c");this.changed={};this._silent={};this._pending={};this.attributes={};this.initialize.apply(this,arguments);f.each(this.properties,function(a,b){d[b]=a.initial});
...
this);this.model.on("error",function(a,b,d){this.trigger("error",a,b,d)},this);this.changed={};this._silent={};this._pending={};this._previousAttributes=f.clone(this.attributes)},set:function(b,d,a){a=a||{};return!b||!this.properties[b]?!1:this._doSet(b,d,a)},get:function(b){return this.attributes[b]},save:function(){return this.model.save()}});g.View=h;g.ViewModel=j})(jQuery,_,Backbone);
